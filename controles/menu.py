...
class Menu:
    ...
    def __init__(self):
        self.grafo = Grafo()
        self.algoritmo = Algoritmo('Algoritmia', self.grafo)
        self.active = True
    ...
    def load(self) -> None:
        ...
        while self.active:
            print(
                "\n▌ OPCIONES"
                "\n▌ 01 — Generar grafo        02 — Ingresar vértice     03 — Ver vértices         04 — Generar vértice    ▐"
                ...
                "\n▌ 17 — Arista (peso-min)    18 — Vértice (num-ady)    19 — Ady. de vértices     20 — Reset Grafo        ▐"
                "\n▌    ∙∙∙   ∙∙∙   —   ∙∙∙   —   ∙∙∙   —   ∙∙∙   —   ∙∙∙   —   ∙∙∙   —   ∙∙∙   —   ∙∙∙   —   ∙∙∙   ∙∙∙    ▐"
                "\n▌ 21 — Alghm. Anchura       22 — Alghm. Profundidad   23 — Alghm. Prim          24 — Alghm. Kruskal     ▐"
                "\n▌ 25 — Alghm. Boruvka       26 — Alghm. Floid-W       27 — Alghm. Ford-F.       28 — Alghm. Dijkstra     ▐"
                # ∙∙∙
                "\n▌ 00 — Volver                                                                                           ▐"
            )
            o = {
                1:  self.get_grafo,          2: self.ingresar_vertice, 3: self.ver_vertices, 4: self.generar_vertice,
                5:  self.ingresar_arista,    6: self.generar_arista,   7: self.ver_aristas,  8: self.algoritmo,
                # ∙∙∙
                ...
                17: self.default,            18: self.default,        19: self.default,     20: self.reset_grafo,
                21: self.alg_anchura,        22: self.alg_profundo,   23: self.alg_prim,    24: self.alg_kruskal,
                25: self.alg_boruvka,        26: self.alg_floid,      27: self.alg_ford,    28: self.alg_dikstra,
                # ∙∙∙
                0: self.exit
            }
    ...
    def ingresar_vertice(self) -> None:
    ...
    def ordenar_ascendente(self):
        """
        Ordenar las aristas del grafo de forma ascendente tiene utilidad para conocer las de mayor peso, con eso en
        los algoritmos se sabe cuál ruta no usar.
        """
    ...
    def alg_anchura(self):
        self.algoritmo.__setattr__('nombre', 'Recorrido en Anchura')
        print(self.algoritmo.__getattribute__('nombre'))

        camino = self.algoritmo.anchura()
        print(camino[0], '|', camino[1])

    def alg_profundo(self):
        self.algoritmo.__setattr__('nombre', 'Recorrido en Profundidad')
        print(self.algoritmo.__getattribute__('nombre'))
    ...
    def alg_kruskal(self):
        pass
    def alg_boruvka(self):
        pass
    def alg_floid(self):
        pass
    def alg_ford(self):
        pass
    def alg_dikstra(self):
        pass

    def algoritmos(self) -> None:
        lista_aristas = self.grafo.get_lista_aristas()
        ...
        o = {
            'p': self.algoritmo.prim, 'd': Algoritmos.dijkstra,
        ...
        conjunto = o[i](self.algoritmo)

        print(conjunto)

    def algoritmo_i(self, i) -> None:
        if i == 0 or i == 5:
        ...
        o = {
            1: self.algoritmo.prim, 2: Algoritmos.dijkstra, 3: Algoritmos.kruskal, 4: Algoritmos.boruvka,
